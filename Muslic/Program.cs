                        ...
                        lecture:
                            ...
                            if (sens == 1)
                            {
                                ...
                                while (gga_nq.Count >= id_bucket && bucket_cout_max >= id_bucket)
                                {
                                    ...
                                    {
                                        id_bucket++;
                                        if (id_bucket == gga_nq.Count+1 || id_bucket == bucket_cout_max )
                                        {
                                            goto fin_gga;
                                        }
                                    }
                            ...
                            if (sens == 2)
                            {
                                    ...
                                    for (j = 0; j < projet.reseaux[projet.reseau_actif].nodes[projet.reseaux[projet.reseau_actif].numnoeud[depart]].pred.Count; j++)
                                    {
                                        ...
                                        else if (projet.param_affectation_horaire.cveh[pred_type] > 0)
                                        {
                                            ...
                                            if (num_service != -1)
                                            {
                                                ...
                                                projet.reseaux[projet.reseau_actif].links[predecesseur].poleV2 = projet.reseaux[projet.reseau_actif].nodes[projet.reseaux[projet.reseau_actif].links[predecesseur].nd].i;
                                            }
                                        }
                                ...
                                while (gga_nq.Count >= id_bucket && bucket_cout_max >= id_bucket)
                                {
                                    ...
                                    {
                                        id_bucket++;
                                        if (id_bucket == gga_nq.Count+1  || bucket_cout_max  == id_bucket)
                                        {
                                            goto fin_gga2;
                                        }
                                    }
